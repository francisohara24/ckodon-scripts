"""Extract email addresses from essay documents and send emails to the extracted addresses."""
...
# Obtain  path and recipients email address for each essay document
...
for recipient_address, path in recipients.items():
    ...
    msg["Subject"] = "Ckodon Reviewed Essay Document"
    msg_body = f"""Dear Ckodon Mentee,

Find attached your reviewed essay document.
